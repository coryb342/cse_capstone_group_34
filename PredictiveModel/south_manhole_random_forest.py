...
# --- CONFIG ---
CSV_PATH = "south_manhole_training_data.csv"
TARGET_COL = "South_Manhole_Level_ft"
MODEL_OUTPUT_PATH = "south_manhole_random_forest.joblib"
DATE_COL = "Date"
...
RENAME_MAP = {
    "Date": "Date",
    "South Influent Flow": "South_Influent",
    ...
    "South Manhole Level (feet)": "South_Manhole_Level_ft",
    "Flow1 (cfs)": "Flow1_cfs",
    "Flow2 (cfs)": "Flow2_cfs",
    "Flow3 (cfs)": "Flow3_cfs",
    "PRCP (Inches)": "PRCP_in",
